...
# Functionality:
        ...
        # Update Item: Implement function update_item that allows users to update the details of an existing item in the inventory. Users should be able to update the price, quantity, and category of the item.
...
# Project Structure:
        ...
        # Create a main loop to interact with the user. The loop should prompt the user to choose from the various options such as adding, updating, viewing, removing items, or searching by category.
