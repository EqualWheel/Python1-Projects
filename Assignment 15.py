...
# Description: Create a function named is_palindrome that takes a string as input and returns True if it is palindrome, and False otherwise.



def is_palindrome(s):
    # Concert the string to lowercase to make the check case-insensitive
    s = s.lower()
