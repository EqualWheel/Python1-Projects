...
# Challenge: Optimize the function to handle large input list efficiently.
# Description: Develop a function called find_common_elements that takes two list as input and returns a new list containing elements that are in common to both input list.
...
# Input: Prompt the user to user to enter two lists
