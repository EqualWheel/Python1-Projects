...
# Description: Develop a program that prompts the user to enter the number of rows for a pattern and then prints a pattern of asterisk(*) in the form of a right triangle.
...
pattern_char = get_valid_character("Eneter the character to use for the pattern: ")
