...
# Processing: Covert the time duration to minutes and seconds.
# Output: Display the converted time duration in minutes and seconds.


# Input: Prompt the user to enter time duration in hours
...
if time_in_hours < 0:
    ...
    print(f"The time duration is {time_in_minutes:.2f} minutes or {time_in_seconds: .2f} seconds.")