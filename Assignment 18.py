...
# Input: Prompt the use to enter two tuples (as space-separated values)
tuple1 = tuple(map(int, input("Enter the first tuple of elements separates by spaces: ").split()))
